...
#include "paging.h"
#include "print.h"
#include "verinfo.h" /* generated by make_git_source_version.sh */
...
static const char duma_vertype[] =
    "DUMA "
...
void DUMA_delFrame(void) {
  ...
  if (nonFreedReported)
    DUMA_Print("DUMA: Reported %i leak(s).\n"
               "DUMA: There are %i extra leak(s) without "
